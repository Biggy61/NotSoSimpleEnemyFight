...
public class Functions
{
    ...
    public static Player.Player player = new Player.Player(_charName, 250, 12, true, startRoom, Weapons.Hand);
                ...
                while (player.isLiving && enemy.isLiving)
                {
                    if (player.CurrentRoom == bossRoom)
                    {
                        while (Phase <= 1)
                        {
                            ...
                            if (enemy.isLiving == false && Phase <= 1)
                            {
                                enemy.isLiving = true;
                                enemy.Hp = enemy.MaxHp;
                                Console.ForegroundColor = ConsoleColor.DarkGreen;
                                Console.WriteLine("First boss phase killed");
                                Console.ForegroundColor = ConsoleColor.White;
                            }
